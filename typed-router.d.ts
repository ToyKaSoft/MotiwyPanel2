...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'panel-analizler': RouteRecordInfo<'panel-analizler', '/panel/analizler', Record<never, never>, Record<never, never>>,
    'panel-boostislemleri': RouteRecordInfo<'panel-boostislemleri', '/panel/boostislemleri', Record<never, never>, Record<never, never>>,
    'panel-katilimlistesi': RouteRecordInfo<'panel-katilimlistesi', '/panel/katilimlistesi', Record<never, never>, Record<never, never>>,
    'panel-tiwyislemleri': RouteRecordInfo<'panel-tiwyislemleri', '/panel/tiwyislemleri', Record<never, never>, Record<never, never>>,
